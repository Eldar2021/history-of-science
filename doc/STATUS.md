...
- **Faz**: Site teknik olarak hazır (kullanıcı, 2026-09-04). Kalan iş **içerik**: M1'in son maddesi
  (+7 olay → 50), sonra Faz A'nın küçük listesi (`yol-haritasi.md`).
...
2. **+7 Aydınlanma olayı** → 50 yayınlanmış olay (`icerik.md`'deki liste, `/com_event`).
3. Faz A'nın kalanı `yol-haritasi.md`'de; ilk sırada canlıda Lighthouse mobil.
